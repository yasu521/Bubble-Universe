...
class TransactionAnimation {
    ...
    startFadeOut() {
        ...
        const targetSection = this.textDirection === "backward" ? 'main-content' : 'content-section';
    ...
    if (backBtn) {
        backBtn.addEventListener('click', function() {
            ...
            switchSection('content-section', 'animation-section', () => {
                ...
                // アニメーションの初期化と開始
                try {
                    const texturePath = 'circle_mofvji.webp';
                    ...
                    switchSection('animation-section', 'main-content');
                }
            });
        });
    }
